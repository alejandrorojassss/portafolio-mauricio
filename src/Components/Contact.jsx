    ...
    <section id="contact" className={styles.section} ref={ref}>
      <div className={styles.container}>
        ...
        <div className="reveal reveal-left">
          <p className={styles.eyebrow}>¿Hablamos?</p>
          ...
          <p className={styles.body}>
            Estoy disponible para proyectos freelance, posiciones como
            desarrollador y colaboraciones académicas. No dudes en escribirme.
          </p>
          <div className={styles.links}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`${styles.contactLink} ${styles.waLink}`}
            >
        ...
        <div className="reveal">
          ...
          {status === "sent" ? (
            <div className={styles.successBox}>
              ...
              <h3 className={styles.successTitle}>¡WhatsApp listo!</h3>

              <p className={styles.successBody}>
                Se abrió WhatsApp con tu mensaje prellenado. Solo dale enviar.
              </p>
      ...
      <footer className={styles.footer}>
        ...
        <p className={styles.footerMono}>· React + Vite ·</p>
      </footer>
    </section>
  );
}
